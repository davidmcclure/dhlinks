...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('links_comment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.user'
        db.delete_column('links_comment', 'user_id')
