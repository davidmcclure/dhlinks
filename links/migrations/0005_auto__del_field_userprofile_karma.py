...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('links_userprofile', 'karma')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.karma'
        db.add_column('links_userprofile', 'karma', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
