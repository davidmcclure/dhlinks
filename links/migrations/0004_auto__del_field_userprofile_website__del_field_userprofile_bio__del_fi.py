...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('links_userprofile', 'website')

        # Deleting field 'UserProfile.bio'
        db.delete_column('links_userprofile', 'bio')

        # Deleting field 'UserProfile.location'
        db.delete_column('links_userprofile', 'location')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.website'
        db.add_column('links_userprofile', 'website', self.gf('django.db.models.fields.CharField')(default=None, max_length=200), keep_default=False)

        # Adding field 'UserProfile.bio'
        db.add_column('links_userprofile', 'bio', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)

        # Adding field 'UserProfile.location'
        db.add_column('links_userprofile', 'location', self.gf('django.db.models.fields.CharField')(default=None, max_length=50), keep_default=False)
